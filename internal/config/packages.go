...
func AllPackages() []Package {
	return []Package{
		...
		{Name: "fd", Type: TypeFormula, Category: "shell_cli", Required: true, Default: true, Description: "Simple, fast and user-friendly alternative to find"},
		...
		{Name: "zoxide", Type: TypeFormula, Category: "shell_cli", Required: true, Default: true, Description: "Smarter cd command, inspired by z and autojump"},
